...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXCoreUIPhotoLibrary.git", exact: "4.0.4")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_PhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Media_PhotoLibrary-4.0.4.xcframework.zip",
			checksum: "1b595a7b535052c02a67b7b4a70ed43a94cd07ca537f3b32b35474e3db2907a3"
		)
	]
)