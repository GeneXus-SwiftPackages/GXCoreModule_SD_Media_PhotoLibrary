...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXCoreUIPhotoLibrary.git", exact: "1.6.0-beta.4")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_PhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_PhotoLibrary-1.6.0-beta.4.xcframework.zip",
			checksum: "4b25f0d170df2ad3dadf010cb985311004178b95fb0c2f2aac4268d5078dc3c6"
		)
	]
)