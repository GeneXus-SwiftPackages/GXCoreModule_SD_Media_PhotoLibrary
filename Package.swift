...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXCoreUIPhotoLibrary.git", exact: "4.1.0-beta.12")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_PhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_PhotoLibrary-4.1.0-beta.12.xcframework.zip",
			checksum: "770ab3f257087766475dd90af082f13801c0db85a3315cfd0a2fcff094105e9d"
		)
	]
)