...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXCoreUIPhotoLibrary.git", exact: "4.2.0-beta.17")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_PhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_PhotoLibrary-4.2.0-beta.17.xcframework.zip",
			checksum: "f3d1fe32c860f50bd91e8c8cec258a76115f674822690a90d8e965f7e5836c15"
		)
	]
)