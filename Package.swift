...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXCoreUIPhotoLibrary.git", exact: "2.2.0-beta.14")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_PhotoLibrary",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_PhotoLibrary-2.2.0-beta.14.xcframework.zip",
			checksum: "ce54f0c8ea502c254c2c5d1ba7b8724cfad310399738fde0adf07a25140e68a3"
		)
	]
)